      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            >
              <div className="relative w-full max-w-sm h-auto group">
                ...
                <img
                  ...
                  className="rounded-lg shadow-xl relative z-10 w-full h-auto object-cover transition-transform duration-300 ease-in-out group-hover:scale-105 group-hover:shadow-2xl"
                />
              </div>
            </motion.div>
          </div>
